...
export enum OPTIONS_ZARA_BENTHAM_I_REALLY_DONT_KNOW_WHAT_TO_DO_WITH_MYSELF {
  A = "I joke but...",
  B = "I'm bored, make them fix my account faster!",
}

const OPTIONS = OPTIONS_ZARA_BENTHAM_I_REALLY_DONT_KNOW_WHAT_TO_DO_WITH_MYSELF;
...
export const i_dont_know_what_to_do_with_myself: ChoosableRouteType = {
  ...
  conditions: {
    [MESSAGE_CONTACT_NAME.ZARA]: {
      routes: {
        [ROUTE_IDS_ZARA_BENTHAM.NOTIFICATION_YOUR_DAY_IS_WORSE_THAN_MINE]: {
