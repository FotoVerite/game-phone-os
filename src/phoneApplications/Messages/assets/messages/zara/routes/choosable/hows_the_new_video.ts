...
export enum OPTIONS_ZARA_BENTHAM_HOW_IS_THE_NEW_VIDEO {
  A = "How's the grind going?",
  B = "Do you still want me to work on your outro?",
  C = "I watched your new video",
}

const OPTIONS = OPTIONS_ZARA_BENTHAM_HOW_IS_THE_NEW_VIDEO;
...
export const your_new_video: ChoosableRouteType = {
  ...
  conditions: {
    [MESSAGE_CONTACT_NAME.ZARA]: {
      routes: {
        [ROUTE_IDS_ZARA_BENTHAM.PROTAG_I_DONT_KNOW_WHAT_TO_DO_WITH_MYSELF]: {
